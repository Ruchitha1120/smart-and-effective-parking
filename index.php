...
<section id="banner" class="banner-section">
  <img src="assets/images/banner-image-20.jpg" alt="" style="width:100vw; height:30vw; margin-top:-12%">
  <div class="container">
    <div class="div_zindex">
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
          <<h1 style="background-color: #6054c2; color: white;">
          </h1>
...
<!-- <section class="section-padding gray-bg"> -->
  <!-- <div class="container"> -->
    <!-- <div class="section-header text-center">
      <h2>Find the Best <span>Parking slots for you</span></h2>
      <p>There are various range of cars for rent.. you can choose your specification and book the car you want</p>
    </div> -->
    <div class="row"> 
