...
<title>Smart Parking | Spot Listing</title>
<!--Bootstrap -->
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price"><?php echo htmlentities($result->PricePerDay);?>rs/- Per Day</p>
            <!-- <ul>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Select Your Spot </h5>
          </div>
...
<option value="CNG">CNG</option>
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Search Spot</button>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> Recently Listed  Spots</h5>
          </div>
...
{  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price"><?php echo htmlentities($result->PricePerDay);?>rs/- Per Hour</p>
                </div>
              </li>
              <?php }} ?>
